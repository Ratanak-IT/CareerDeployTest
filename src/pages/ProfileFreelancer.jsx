        ...
        {!isOwner && (
          <>
            ...
            <div className="mt-4">
              ...
              {!servicesLoading && !servicesError && servicesForCards.length > 0 && (
                <div className="grid gap-3 sm:gap-5 justify-items-center grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 max-w-[1240px] mx-auto">
          ...
          <div className="mt-8 space-y-10">
            ...
            <div>
              ...
              {serviceBookmarks.length === 0 ? (
                ...
                <div className="grid gap-5 justify-items-center grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 max-w-[1240px] mx-auto">
