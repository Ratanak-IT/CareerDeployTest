      ...
      <div className="relative w-full">
        ...
        >
          ...
          <div className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute top-full left-0 mt-1 w-52 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl shadow-xl z-50 py-1">
                {categories.map((cat) => (
                  <button
                    key={cat}
                    type="button"
