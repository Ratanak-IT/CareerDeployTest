...
function ContactRow({ contact, isActive, onClick }) {
  return (
    <button
      onClick={onClick}
      className={`w-full flex items-center gap-3 px-3 sm:px-4 py-3 rounded-xl transition-colors duration-150 text-left
...
function ChatBubble({ message, contact }) {
  ...
  return (
    <div className={`flex items-end gap-2 ${isMe ? "flex-row-reverse" : "flex-row"}`}>
      ...
      <div
        className={`max-w-[65%] px-3 sm:px-4 py-2.5 rounded-2xl text-sm leading-relaxed
          ${isMe
      ...
      >
        ...
        */}
        ...
        >
          ...
          {/* Input bar */}
          <div className="px-3 sm:px-4 py-4 flex items-center gap-3">
            <input
              type="text"
