...
export default function MainSection() {
  return (
    ...
    >
      ...
      */}
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-[120px] 
                      flex flex-col lg:flex-row items-center justify-start lg:justify-between 
                      min-h-[calc(100vh-72px)] sm:min-h-[calc(100vh-80px)] lg:min-h-[calc(100vh-89px)] pt-10 pb-6 lg:pt-0 lg:pb-0">
        ...
        <div className="w-full lg:w-[45%] relative flex justify-center items-end self-end">
          <img
            ...
            className="relative z-10 object-contain w-[75%] sm:w-[65%] lg:w-full h-auto"
            style={{ 
