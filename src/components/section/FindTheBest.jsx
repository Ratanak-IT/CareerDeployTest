...
export default function FindTheBest() {
  return (
    <section
      className={[
        "w-full py-10 lg:py-24 transition-colors duration-300",
        "bg-[#f8f9fb]",
        "dark:bg-[linear-gradient(160deg,#0d1b2e_0%,#0f2240_50%,#0d1520_100%)]",
      ].join(" ")}
      style={{ fontFamily: "'Poppins', sans-serif" }}
    >
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-[120px] flex flex-col lg:flex-row items-center gap-8 lg:gap-8">
