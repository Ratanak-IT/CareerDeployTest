...
export default function PeopleLoveWorking() {
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-[120px] grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
        {/* ── LEFT: Text & Stats ── */}
        <div className="space-y-8 lg:space-y-12">
          ...
          {/* Stats Grid */}
          <div className="grid grid-cols-2 gap-y-8 lg:gap-y-12 gap-x-6 lg:gap-x-8">
            {/* Stat 1 */}
