...
function Skeleton() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#07111f] py-4 sm:py-8 px-3 sm:px-4">
...
function ErrorState({ message, onBack }) {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#07111f] flex items-center justify-center px-4">
...
export default function CardDetailFreelancer() {
  ...
  return (
    <div className={`min-h-screen ${bg} transition-colors duration-300`} style={{ fontFamily: "'Poppins', sans-serif" }}>
      <div className="max-w-5xl mx-auto px-3 sm:px-5 lg:px-8 py-4 sm:py-8">
