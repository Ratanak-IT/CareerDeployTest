  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4 flex flex-col flex-1">
        ...
        <p
          className="text-gray-400 text-xs dark:text-gray-300 leading-relaxed mb-3 overflow-hidden line-clamp-3"
        >
          {description}
        </p>
...
export default function JobsGrid({
  ...
  return (
    <>
      <div className="grid gap-3 sm:gap-5 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        {visible.map((job) => (
