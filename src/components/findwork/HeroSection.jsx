  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[120px]">
          <div className="flex flex-col lg:flex-row items-center justify-between
            ...
            <div className="w-full lg:w-[52%] flex flex-col gap-5
              ...
              <h1 className="font-bold leading-[1.1] m-0
                             text-[24px] sm:text-[34px] md:text-[44px] lg:text-[50px] xl:text-[58px]
      ...
      <div
        className="absolute bottom-0 left-0 right-0 z-30 px-4 sm:px-6 lg:px-30 2xl:px-60"
