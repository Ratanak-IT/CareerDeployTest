...
export default function HowIsWork() {
  ...
  return (
    <section
      className={[
        "w-full py-10 lg:py-16 transition-colors duration-300",
        // light bg
        "bg-white",
        // dark bg gradient
    ...
    >
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-[120px]">
        ...
        <div
          className={[
            "mt-[30px] grid grid-cols-1 sm:grid-cols-3 gap-4 rounded-2xl p-6 sm:p-8 lg:p-12 transition-all duration-300",
            // light
