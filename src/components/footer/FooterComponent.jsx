  ...
  return (
    <footer style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      >
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-[120px] pt-10 sm:pt-14 lg:pt-16 pb-8 sm:pb-12 relative z-10">
      ...
      <div className="bg-[linear-gradient(90deg,#1e3a8a_0%,#2563eb_40%,#3B6CF4_60%,#7C3AED_100%)]">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-[120px] py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p
